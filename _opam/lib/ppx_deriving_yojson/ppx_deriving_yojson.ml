...
# 18 "ppx_deriving_yojson.cppo.ml"
open Longident
open Location
open Asttypes
open Parsetree
...
# 76 "ppx_deriving_yojson.cppo.ml"
      let name = name.Location.txt in
      
# 78 "ppx_deriving_yojson.cppo.ml"
...
# 125 "ppx_deriving_yojson.cppo.ml"
        match field.prf_desc with
        
# 129 "ppx_deriving_yojson.cppo.ml"
        | 
# 129 "ppx_deriving_yojson.cppo.ml"
           
        Rtag({ txt = label },  true (*empty*),  [])  
# 129 "ppx_deriving_yojson.cppo.ml"
                                                 ->
          
# 131 "ppx_deriving_yojson.cppo.ml"
          let attrs = field.prf_attributes in
          
# 133 "ppx_deriving_yojson.cppo.ml"
          Exp.case (Pat.variant label None)
                   [%expr `List [`String [%e str (attr_name label attrs)]]]
        | 
# 135 "ppx_deriving_yojson.cppo.ml"
           
        Rtag({ txt = label },  false,  [{ ptyp_desc = Ptyp_tuple typs }])  
# 135 "ppx_deriving_yojson.cppo.ml"
                                                                       ->
          
# 137 "ppx_deriving_yojson.cppo.ml"
          let attrs = field.prf_attributes in
          
# 139 "ppx_deriving_yojson.cppo.ml"
        ...
        | 
# 143 "ppx_deriving_yojson.cppo.ml"
           
        Rtag({ txt = label },  false,  [typ])  
# 143 "ppx_deriving_yojson.cppo.ml"
                                           ->
          
# 145 "ppx_deriving_yojson.cppo.ml"
          let attrs = field.prf_attributes in
          
# 147 "ppx_deriving_yojson.cppo.ml"
...
# 233 "ppx_deriving_yojson.cppo.ml"
      match field.prf_desc with
      
# 237 "ppx_deriving_yojson.cppo.ml"
      Rinherit _ -> true
      | _ -> false) fields
    in
    let tag_cases = tags |> List.map (fun field ->
      
# 242 "ppx_deriving_yojson.cppo.ml"
      match field.prf_desc with
      
# 246 "ppx_deriving_yojson.cppo.ml"
      | 
# 246 "ppx_deriving_yojson.cppo.ml"
...
# 248 "ppx_deriving_yojson.cppo.ml"
        let attrs = field.prf_attributes in
        
# 250 "ppx_deriving_yojson.cppo.ml"
        Exp.case [%pat? `List [`String [%p pstr (attr_name label attrs)]]]
                 [%expr Result.Ok [%e Exp.variant label None]]
      | 
# 252 "ppx_deriving_yojson.cppo.ml"
         
        Rtag({ txt = label },  false,  [{ ptyp_desc = Ptyp_tuple typs }])  
# 252 "ppx_deriving_yojson.cppo.ml"
                                                                     ->
        
# 254 "ppx_deriving_yojson.cppo.ml"
        let attrs = field.prf_attributes in
        
# 256 "ppx_deriving_yojson.cppo.ml"
      ...
      | 
# 259 "ppx_deriving_yojson.cppo.ml"
         
        Rtag({ txt = label },  false,  [typ])  
# 259 "ppx_deriving_yojson.cppo.ml"
                                         ->
        
# 261 "ppx_deriving_yojson.cppo.ml"
        let attrs = field.prf_attributes in
        
# 263 "ppx_deriving_yojson.cppo.ml"
...
# 277 "ppx_deriving_yojson.cppo.ml"
        match field.prf_desc with
        
# 281 "ppx_deriving_yojson.cppo.ml"
        | Rinherit typ -> typ
        | _ -> assert false)
...
let ser_str_of_type ~options ~path ({ ptype_loc = loc } as type_decl) =
  ...
  | kind ->
    ...
    ([],
     [Vb.mk
        ~attrs:[
# 434 "ppx_deriving_yojson.cppo.ml"
                 { attr_name = 
                                                { txt =  "ocaml.warning"; loc = !Ast_helper.default_loc }; 
                                              attr_payload =  PStr [%str "-39"]; 
...
let desu_str_of_type ~options ~path ({ ptype_loc = loc } as type_decl) =
  ...
  | kind ->
    ...
    ([],
     [Vb.mk ~attrs:[
# 645 "ppx_deriving_yojson.cppo.ml"
                     { attr_name = 
                                                { txt =  "ocaml.warning"; loc = !Ast_helper.default_loc }; 
                                              attr_payload =  PStr [%str "-39"]; 
                                              attr_loc = !Ast_helper.default_loc } 
