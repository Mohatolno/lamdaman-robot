...
# 132 "ppx_deriving_eq.cppo.ml"
            Pat.variant label.txt popt
          
# 134 "ppx_deriving_eq.cppo.ml"
          in
          match field with
          | 
# 136 "ppx_deriving_eq.cppo.ml"
             {prf_desc = Rtag(label,  true (*empty*),  []); _}  
# 136 "ppx_deriving_eq.cppo.ml"
                                                 ->
            Exp.case (pdup (fun _ -> variant label None)) [%expr true]
          | 
# 138 "ppx_deriving_eq.cppo.ml"
